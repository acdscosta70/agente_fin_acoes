...
# Defina o modelo LLM, usando GPT-4
llm = ChatOpenAI(api_key=openai_api_key, model="gpt-4o")

# Defina a ferramenta de busca
search_tool = SerperDevTool(api_key=serper_api_key)

# Defina seus agentes com funções e objetivos
...
# Instancie sua equipe com um processo sequencial
equipe = Crew(
